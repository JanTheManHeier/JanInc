...
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME = 'Thomas50_Spillscore')
CREATE TABLE Thomas50_Spillscore (
    ...
    try {
        ...
        if (req.method === 'POST') {
            ...
            await executeQuery(connection,
                'INSERT INTO Thomas50_Spillscore (navn, score) VALUES (@navn, @score)',
                [
        ...
        context.log.error('thomas50-spillscore error:', err.message);
