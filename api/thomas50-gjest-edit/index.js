...
IF COL_LENGTH('Thomas50_GjestEdit','nyttNavn') IS NULL ALTER TABLE Thomas50_GjestEdit ADD nyttNavn NVARCHAR(100) NULL;
IF COL_LENGTH('Thomas50_GjestEdit','jobb')     IS NULL ALTER TABLE Thomas50_GjestEdit ADD jobb NVARCHAR(200) NULL;
IF COL_LENGTH('Thomas50_GjestEdit','bord')     IS NULL ALTER TABLE Thomas50_GjestEdit ADD bord INT NULL;
IF COL_LENGTH('Thomas50_GjestEdit','sete')     IS NULL ALTER TABLE Thomas50_GjestEdit ADD sete INT NULL;
IF COL_LENGTH('Thomas50_GjestEdit','bordType') IS NULL ALTER TABLE Thomas50_GjestEdit ADD bordType INT NULL;
IF COL_LENGTH('Thomas50_GjestEdit','fbUrl')    IS NULL ALTER TABLE Thomas50_GjestEdit ADD fbUrl NVARCHAR(500) NULL;
IF COL_LENGTH('Thomas50_GjestEdit','liUrl')    IS NULL ALTER TABLE Thomas50_GjestEdit ADD liUrl NVARCHAR(500) NULL;
IF COL_LENGTH('Thomas50_GjestEdit','igUrl')    IS NULL ALTER TABLE Thomas50_GjestEdit ADD igUrl NVARCHAR(500) NULL;
    ...
    try {
        ...
        if (req.method === 'DELETE') {
            ...
            await executeQuery(connection,
                'DELETE FROM Thomas50_GjestEdit WHERE navn = @navn',
