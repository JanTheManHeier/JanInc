...
IF NOT EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_NAME = 'Thomas50_Highscore')
CREATE TABLE Thomas50_Highscore (
    ...
    try {
        ...
        if (req.method === 'POST') {
            ...
            await executeQuery(connection,
                'INSERT INTO Thomas50_Highscore (navn, score, antall) VALUES (@navn, @score, @antall)',
                [
        ...
        context.log.error('thomas50-highscore error:', err.message);
